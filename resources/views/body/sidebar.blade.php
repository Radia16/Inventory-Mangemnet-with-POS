            ...
            @endif
                <li>
                    ...
                    <div class="collapse" id="sidebar3">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('brand_view') }}">Manage Brand</a>
                            </li>

                            <li>
                                <a href="{{ route('unit_show') }}">Units</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div class="collapse" id="department">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('dept_view') }}" >List of Department</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div class="collapse" id="employee">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('emp.add') }}" >Add Employee</a>
                            </li>
                            <li>
                                <a href="{{ route('emp.list_view') }}" >List of Employee</a>
                            </li>
                        </ul>
                    </div>
                </li>
