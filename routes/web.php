...
// department route
Route::get('/show/dept',[DepartmentController::class, 'departmentView'])->name('dept_view');
Route::post('/store/dept',[DepartmentController::class,'departmentStore'])->name('dept.add');
Route::get('/edit/dept/{id}',[DepartmentController::class,'departmentEdit'])->name('dept.edit');
Route::post('/update/dept/{id}',[DepartmentController::class,'departmentUpdate'])->name('dept.update');
Route::get('/delete/dept/{id}',[DepartmentController::class, 'departmentDelete'])->name('dept.del');

// Employee route
Route::get('/show/employee',[EmployeeController::class,'employeeListView'])->name('emp.list_view');
Route::get('/add/employee',[EmployeeController::class,'employeeAdd'])->name('emp.add');
Route::post('/store/employee',[EmployeeController::class,'employeeStore'])->name('emp.store');
Route::get('/edit/{id}',[EmployeeController::class,'employeeEdit'])->name('emp.edit');
Route::post('/update', [EmployeeController::class, 'EmployeeUpdate'])->name('employee.update');
Route::get('/delete/{id}', [EmployeeController::class, 'employeetDelete'])->name('employee.del');
Route::get('/details/{id}', [EmployeeController::class, 'employeeDetails'])->name('employee.details');

//Brand ro
Route::get('/show/brand', [BrandController::class,'brandView'])->name('brand_view');
Route::post('/add/brand',[BrandController::class,'brandStore'])->name('brand.store');
Route::get('/edit/brand/{id}',[BrandController::class,'brandEdit'])->name('brand.edit');
Route::post('/update/brand/{brand_id}',[BrandController::class,'updateBrand'])->name('update.brand');
Route::get('/delete/brand/{id}',[BrandController::class, 'brandDelete'])->name('del');

//UNIT route
Route::get('/show/units', [UnitController::class, 'UniteShow'])->name('unit_show');
Route::post('/store/units', [UnitController::class, 'UniteAdd'])->name('unit_add');
Route::get('/edit/unit/{id}', [UnitController::class, 'UniteEdit'])->name('unit_edit');
Route::post('/update/unit/{id}', [UnitController::class, 'UniteUpdate'])->name('unit_update');
Route::get('/delete/unit/{id}', [UnitController::class, 'UniteDelete'])->name('unit.del');
